      ...
      <div className="flex flex-col space-y-4 py-4 bg-emerald-950">
        <div className="flex justify-center">
          <Link href="https://medium.com/@tanloiit2010/part-1-develop-a-post-list-api-using-phoenix-framework-and-elixir-430836d7c0e3" className="flex items-center space-x-2 text-emerald-50/50 hover:text-gray-100/80">
            ...
            <LinkIcon className="block h-6 w-8 border-2 rounded-lg"></LinkIcon>
          </Link>
        </div>
        <div className="flex justify-center space-x-4 text-sm text-emerald-50/50">
          <Link href="https://github.com/WuYenTing/My_blog_front" className="flex items-center space-x-2 hover:text-gray-100/80">
            <p>Front-end</p>
            <CodeBracketIcon className="block h-4 w-5 border-1 rounded-sm"></CodeBracketIcon>
          </Link>
          <Link href="https://github.com/WuYenTing/My_blog" className="flex items-center space-x-2 hover:text-gray-100/80">
            <p>Back-end</p>
            <CodeBracketIcon className="block h-4 w-5 border-1 rounded-sm"></CodeBracketIcon>
          </Link>
        </div>
        <div className="flex justify-center text-gray-200/60">
